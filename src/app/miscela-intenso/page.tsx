...
export default function MiscelaIntenso() {
  return (
    <>
      <section className="relative overflow-hidden bg-gradient-to-br from-[#8b7158] via-[#6b5948] to-[#4b3a28] py-16 text-white md:py-24">
        <div className="absolute inset-0 opacity-20" style={{ backgroundImage: "url('https://www.musetti.it/wp-content/uploads/2023/05/layout-miscela_Onda-BG_Intenso.png')" }} />
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 items-center max-w-6xl mx-auto">
            <div className="text-center md:text-left order-2 md:order-1">
              ...
              <h1 className="text-5xl md:text-7xl font-bold mb-6">ENJOY YOUR<br/>INTENSO.</h1>
              <p className="text-2xl md:text-3xl font-light">
                Káva s rozhodným a plným charakterem
              </p>
            </div>
            ...
            <div className="flex justify-center items-center gap-6 order-1 md:order-2">
              <img
                ...
                alt="Balení směsi Intenso"
                className="w-5/12 max-w-xs object-contain drop-shadow-2xl animate-fadeInUp animate-gentleFloat"
              />
              <img
                src="https://www.musetti.it/wp-content/uploads/2023/06/ENJOY_YOUR_INTENSO-1200x1200.webp"
                alt="Brand vizuál Intenso"
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <div className="h-32 flex items-center justify-center mb-8">
                <img src="https://www.musetti.it/wp-content/uploads/2023/05/Miscela_Intenso-e1685453730728.png" alt="Logotyp směsi Intenso" className="h-20 w-auto object-contain" />
              </div>

              <h2 className="text-4xl md:text-5xl font-bold mb-6">SMĚS INTENSO</h2>
              <h3 className="text-2xl md:text-3xl text-gray-700 mb-8">
                Káva se silnou a dlouhou chutí, s velkým tělem
              </h3>

              <p className="text-gray-700 text-lg leading-relaxed mb-8 max-w-4xl mx-auto">
                Nadčasová a nikdy banální směs s rozhodnou a krémovou chutí. Intenzivní blend spojuje klasické aroma s plnou, obklopující strukturou, doprovázenou tóny kakaa a jemnou, měkkou dochutí. Výrazné aroma dokáže oslovit milovníky kávy, kteří chtějí zažít její nejsilnější a nejčistší podobu.
              </p>
              ...
              <div className="flex flex-col md:flex-row items-center justify-center gap-8 mb-8">
                <div>
                  ...
                  <div className="flex gap-2 justify-center">
                    {[1,2,3,4,5].map(i => (
                      <div key={i} className="w-10 h-10 rounded-full bg-[#6b5948]"></div>
                    ))}
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-16 max-w-4xl mx-auto">
            <div className="text-center bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              <img src="https://www.musetti.it/wp-content/uploads/2023/05/layout-miscela_Cacao-2.png" alt="Kakao" className="w-40 h-40 mx-auto mb-6 object-contain" />
              <h3 className="text-3xl font-semibold">Kakao</h3>
            </div>

            <div className="text-center bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              <img src="https://www.musetti.it/wp-content/uploads/2023/05/layout-miscela_Pasticceria.png" alt="Cukrářské tóny" className="w-40 h-40 mx-auto mb-6 object-contain" />
              <h3 className="text-3xl font-semibold">Cukrářské tóny</h3>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            <div className="text-center">
              ...
              <div className="rounded-2xl border border-gray-100 bg-white p-8">
                <img src="https://www.musetti.it/wp-content/uploads/2023/05/Intenso_Mappa_Caffe-1200x698.webp" alt="Mapa původu kávy Intenso" className="w-full rounded-lg bg-white object-contain" />
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="rounded-2xl border border-gray-100 bg-white p-8">
                <img src="https://www.musetti.it/wp-content/uploads/2023/05/Intenso_Spiderchart-1024x800.webp" alt="Chuťový spider chart Intenso" className="w-full rounded-lg bg-white object-contain" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-6xl mx-auto mb-12">
            <div className="hover:scale-105 transition-transform duration-300">
              <img src="https://www.musetti.it/wp-content/uploads/2023/05/layout-miscela_Intenso-Cialde_100-400x329.webp" alt="Intenso pody" className="mb-4 aspect-square w-full rounded-lg object-contain bg-white p-4 shadow-sm" />
              <p className="font-semibold text-lg">Pody</p>
            </div>

            <div className="hover:scale-105 transition-transform duration-300">
              <img src="https://www.musetti.it/wp-content/uploads/2023/05/Capsule_Intenso-1-200x388.webp" alt="Intenso kapsle" className="mb-4 aspect-square w-full rounded-lg object-contain bg-white p-4 shadow-sm" />
              <p className="font-semibold text-lg">Kapsle</p>
            </div>

            <div className="hover:scale-105 transition-transform duration-300">
              <img src="https://www.musetti.it/wp-content/uploads/2023/05/Macinato_Intenso-400x603.webp" alt="Intenso mletá káva" className="mb-4 aspect-square w-full rounded-lg object-contain bg-white p-4 shadow-sm" />
              <p className="font-semibold text-lg">Mletá</p>
            </div>

            <div className="hover:scale-105 transition-transform duration-300">
              <img src="https://www.musetti.it/wp-content/uploads/2023/05/Grani_Intenso-1-200x450.webp" alt="Intenso zrnková káva" className="mb-4 aspect-square w-full rounded-lg object-contain bg-white p-4 shadow-sm" />
